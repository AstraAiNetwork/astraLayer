...
const config: HardhatUserConfig = {
    ...
    networks: {
      ...
      linea_mainnet: {
        ...
        astra: {
            url: `https://rpc-pale-red-aphid-1i0jilizqq.t.conduit.xyz`,
            accounts: [`${process.env.PRIVATE_KEY}`],
          },
        // for mainnet
    "base-mainnet": {
    ...
    etherscan: {
        apiKey: {
            ...
            "base-sepolia": `${process.env.API_KEY_BASE_ONLINE}`,
            ...
            linea_sepolia: `${process.env.API_KEY_LINEA_GOERLI}`,
            astra_test: "abc"
        ...
        customChains: [
            ...
            },
            {
                ...
                chainId: 96834,
                urls: {
                    apiURL: "https://explorer-pale-red-aphid-1i0jilizqq.t.conduit.xyz/api",
                    browserURL: "https://explorerl2new-pale-red-aphid-1i0jilizqq.t.conduit.xyz",
                },
            },
